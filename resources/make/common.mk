...
ERL_LIBS=.:..:../yaws-websocket:$(shell $(LFETOOL) info erllibs)
OS := $(shell uname -s)
ifeq ($(OS),Linux)
        HOST=$(HOSTNAME)
endif
...
get-version:
	...
	-eval "lfe_io:format(\"~p~n\",['yaws-websocket-util':'get-versions'()])." \
...
install: compile
	@echo "Installing yaws-websocket ..."
	@PATH=$(SCRIPT_PATH) lfetool install lfe

upload: $(EXPM) get-version
	@echo "Preparing to upload yaws-websocket ..."
	@echo
	@echo "Package file:"
	@echo
	@cat package.exs
